...
export default function Navigation() {
  ...
  return (
    <nav className="navbar">
      ...
      <div className="nav-mono">AS</div>
      <div className="nav-links">
        <a href="#projects">Projects</a>
        <a href="#skills">Skills</a>
        <a href="#contact">Contact</a>
        <a href="/Abhijeet_Singh_Resume.pdf" download="Abhijeet_Singh_Resume.pdf" target="_blank" rel="noopener noreferrer" className="nav-resume-btn">
