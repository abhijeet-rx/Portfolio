  ...
  return (
    <>
        ...
        <div className="hero-inner">
          <div className="hero-content">
            ...
            <h1 className="hero-title">
              ...
              <span className="hero-title-line accent">Beautiful</span>
              <span className="hero-title-line">Interfaces.</span>
            </h1>
            <p className="hero-desc">
              Product UI, mobile-first UX, and brand-led interfaces focused on clarity, emotion, and conversion.
            </p>
            <div className="hero-actions">
              <a href="#projects" className="btn-primary">View Case Studies <span>↓</span></a>
            ...
            <div className="hero-socials">
              ...
              <a href="mailto:abhijeet@example.com" className="social-link" title="Email">
      ...
      <section className="section" id="projects">
        ...
        <p>Your design work will be displayed here</p>
      </section>
    </>
  )
}
